...
class _HomepageState extends State<Homepage> {
  ...
  // Updated: using external app launch mode with error handling
  ...
  // New: added functionality to save contact to phone
  Future<void> saveContact(String name, String phone) async {
    if (await FlutterContacts.requestPermission()) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Contact saved to phone.")));
    } else {
                        ...
                        .map((DocumentSnapshot document) {
                          ...
                          return ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () {
                                callUser(data["phone"]);
                                saveContact(data["name"], data["phone"]);
                              },
                            ),
                          );
                        })
